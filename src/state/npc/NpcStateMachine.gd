...
@onready var state: NpcState = (func get_initial_state() -> NpcState:
...
func _transition_to_next_state(target_state_path: String, data: Dictionary = {}) -> void:
	logger.log_info("State transitioned to: " + target_state_path + " for npc " + owner.customerName, logger.LogType.LOG_STATE)
